...
void DateTime::incrYear(const unsigned long& by)
{
...
void DateTime::incrMinute(const unsigned long& by)
{
...
void DateTime::incrSecond(const unsigned long& by)
{
...
void DateTime::incrMilliSecond(const unsigned long& by)
{
...
void DateTime::decrYear(const unsigned long& by)
{
	DateTime::Iterator<ByYear> it = *this;
...
void DateTime::decrMonth(const unsigned long& by)
{
	DateTime::Iterator<ByMonth> it = *this;
...
void DateTime::decrDay(const unsigned long& by)
{
	DateTime::Iterator<ByDay> it = *this;
...
void DateTime::decrHour(const unsigned long& by)
{
	DateTime::Iterator<ByHour> it = *this;
...
void DateTime::decrMinute(const unsigned long& by)
{
	DateTime::Iterator<ByMinute> it = *this;
...
void DateTime::decrSecond(const unsigned long& by)
{
	DateTime::Iterator<BySecond> it = *this;
...
void DateTime::decrMilliSecond(const unsigned long& by)
{
	DateTime::Iterator<ByMillisecond> it = *this;
