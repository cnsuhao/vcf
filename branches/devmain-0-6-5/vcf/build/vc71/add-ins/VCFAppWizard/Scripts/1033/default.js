...
//DEBUG//////////////////////////////////////////////////////////////
		...
		if(bLibDynamic)
		{
			if(bLibRemote)
			{
				CLTool.PreprocessorDefinitions = "WIN32;_DEBUG;USE_FRAMEWORK_DLL;USE_GRAPHICSKIT_DLL;USE_APPKIT_DLL;USE_NETKIT_DLL;USE_REMOTEKIT_DLL";
			}
			else if(bLibNet)
			{
				CLTool.PreprocessorDefinitions = "WIN32;_DEBUG;USE_FRAMEWORK_DLL;USE_GRAPHICSKIT_DLL;USE_APPKIT_DLL;USE_NETKIT_DLL";
			}
			else
			{
		...
		else if(bLibStatic)
		{
			if(bLibRemote)
			{
				CLTool.PreprocessorDefinitions = "WIN32;_DEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB;USE_NETKIT_LIB;USE_REMOTEKIT_LIB";
			}
			else if(bLibNet)
			{
				CLTool.PreprocessorDefinitions = "WIN32;_DEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB;USE_NETKIT_LIB";
			}
			else
			{
				CLTool.PreprocessorDefinitions = "WIN32;_DEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB";
			}
		}
...
//RELEASE////////////////////////////////////////////////////////////
		...
		if(bLibDynamic)
		{
			if(bLibRemote)
			{
				CLTool.PreprocessorDefinitions = "WIN32;NDEBUG;USE_FRAMEWORK_DLL;USE_GRAPHICSKIT_DLL;USE_APPKIT_DLL;USE_REMOTEKIT_DLL;USE_NETKIT_DLL";
			}
			else if(bLibNet)
			{
				CLTool.PreprocessorDefinitions = "WIN32;NDEBUG;USE_FRAMEWORK_DLL;USE_GRAPHICSKIT_DLL;USE_APPKIT_DLL;USE_NETKIT_DLL";
			}
			else
			{
		...
		else if(bLibStatic)
		{
			if(bLibRemote)
			{
				CLTool.PreprocessorDefinitions = "WIN32;NDEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB;USE_NETKIT_LIB;USE_REMOTEKIT_LIB";
			}
			else if(bLibNet)
			{
				CLTool.PreprocessorDefinitions = "WIN32;NDEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB;USE_NETKIT_LIB";
			}
			else
			{
				CLTool.PreprocessorDefinitions = "WIN32;NDEBUG;USE_FRAMEWORK_LIB;USE_GRAPHICSKIT_LIB;USE_APPKIT_LIB";
			}
		}
		CLTool.RuntimeTypeInfo = true;
		CLTool.SuppressStartupBanner = true;
