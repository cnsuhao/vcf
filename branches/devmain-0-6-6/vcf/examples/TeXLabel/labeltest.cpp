...
public:
	HelloWindow()
		: Window()
	{
		ControlSized += new ControlEventHandler<HelloWindow>(this,
			HelloWindow::onResized, "HelloWindow::onResized" );
...
public:
	...
	virtual bool initRunningApplication()
	{
		...
		Window *mainWindow = new HelloWindow();
