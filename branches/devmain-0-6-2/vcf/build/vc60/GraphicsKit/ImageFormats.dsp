...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "$(VCF_INCLUDE)" /I "..\..\..\thirdparty\common\FreeImage\Source" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "NO_MFC" /D "IMAGEFORMATS_DLL" /D "IMAGEFORMATS_EXPORTS" /D "FREEIMAGE_LIB" /D "USE_FREEIMAGE_LIB" /D "USE_FRAMEWORK_DLL" /D "USE_GRAPHICSKIT_DLL" /D "USE_APPKIT_DLL" /D "BUILD_IMAGEFORMATS_LIB" /Fo"vc6/Release/" /FD /c
