...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_INCLUDE)" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "NETKIT_DLL" /D "NETKIT_EXPORTS" /D "USE_FRAMEWORK_DLL" /D "BUILD_NETWORKKIT_LIB" /Fd"..\..\..\bin\NetworkKit_vc6_d.pdb" /Yu"vcf/NetworkKit/NetworkKit.h" /FD /GZ /c
