...
# ADD CPP /nologo /MD /W3 /GR /GX /O1 /I "$(VCF_INCLUDE)/core" /I "$(VCF_INCLUDE)/exceptions" /I "$(VCF_INCLUDE)/dragdrop" /I "$(VCF_INCLUDE)/events" /I "$(VCF_INCLUDE)/graphics" /I "$(VCF_INCLUDE)/implementer" /I "$(VCF_INCLUDE)/implementerKit" /I "$(VCF_INCLUDE)/utils" /I "$(VCF_INCLUDE)/io" /I "$(VCF_INCLUDE)/com" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "NO_MFC" /D "USE_FOUNDATIONKIT_DLL" /D "USE_GRAPHICSKIT_DLL" /D "USE_APPLICATIONKIT_DLL" /FD /c
